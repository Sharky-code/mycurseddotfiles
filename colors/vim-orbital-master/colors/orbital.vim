...
if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=16 ctermfg=75 cterm=NONE guibg=#EBECED guifg=#354C4B gui=NONE
    set background=dark
    ...
    hi String ctermbg=235 ctermfg=110 cterm=NONE guibg=#EBECED guifg=#87afd7 gui=NONE
