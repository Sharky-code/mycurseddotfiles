...
sketchybar --add       event              window_focus                                  \
           ...
           --subscribe system.label       front_app_switched                            \
                                                                                        \
           --add       alias              "Control Centre,Battery" e                    \
           --set "Control Centre,Battery" update_freq=4                                 \
                                          drawing=$HAS_BATTERY                          \
                                          label.drawing=off                             \
                                          ...
                                          popup.align=right                             \
                                                                                        \
           --add       item               battery.details popup."Control Centre,Battery"\
           --set       battery.details    updates=$HAS_BATTERY                          \
                                          script="$PLUGIN_DIR/battery.sh"               \
                                          label.padding_right=8                         \
           --subscribe battery.details    battery                                       \
                                                                                        \
           --add       alias              "Control Centre,WiFi" e                       \
           --set    "Control Centre,WiFi" update_freq=4                                 \
                                          icon.drawing=off                              \
                                          label.drawing=off                             \
                                          ...
                                          popup.align=right                             \
                                                                                        \
           --add       item               wifi.details popup."Control Centre,WiFi"      \
           --set       wifi.details       updates=on                                    \
                                          script="$PLUGIN_DIR/wifi.sh"                  \
                                          label.padding_right=5                         \
           --subscribe wifi.details       wifi                                          \
                                                                                        \
           --add       alias              "Control Centre,Sound" e                      \
           --set   "Control Centre,Sound" update_freq=4                                 \
                                          icon.drawing=off                              \
                                          label.drawing=off                             \
                                          background.padding_left=-4                    \
                                          background.padding_right=-4                   \
