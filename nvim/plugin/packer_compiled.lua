...
_G.packer_plugins = {
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/justquitstoptrying/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/Users/justquitstoptrying/.local/share/nvim/site/pack/packer/start/onedark.vim",
